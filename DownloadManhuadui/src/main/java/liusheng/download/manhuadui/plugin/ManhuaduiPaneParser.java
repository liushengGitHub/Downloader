...
import liusheng.download.manhuadui.parse.ManHuaDuiSearchInfoParser;
import liusheng.download.manhuadui.parse.ManHuaDuiSearchPageParser;
import liusheng.download.manhuadui.parse.ManhuiduiDownloadAction;
...
public class ManhuaduiPaneParser implements Parser<Object, Pane> {
    private final Parser infoParser = new ManHuaDuiSearchInfoParser();
    private final SearchPageParser pageParser = new ManHuaDuiSearchPageParser();
                ...
                .map(i -> {
                    ...
                    SearchItemPane searchItemPane =
                            new SearchItemPane(i, item, pane.getDownloadingPaneContainer(),
                                    new ManhuiduiDownloadAction(item.getHref(), pane.getDownloadingPaneContainer()));
